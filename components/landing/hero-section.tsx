...
export function HeroSection() {
    ...
    return (
        <section className="relative w-full bg-gradient-to-b from-background to-secondary dark:from-background dark:to-secondary flex justify-center">
            {/* Hero content */}
            <div className="container mx-auto px-4 py-20 md:py-32 flex justify-center">
                ...
                >
                    <h1 className="text-4xl md:text-6xl font-bold tracking-tighter mb-6 text-foreground dark:text-foreground">
                        Monitor Your Applications with <span className="text-primary dark:text-primary">Precision</span>
                    </h1>
